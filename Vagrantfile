...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    config.vm.hostname = "idtreporter-dev"
    ...
    config.vm.network "forwarded_port", guest: 8020, host:8004
    ...
    # commands. This is important since the prompt runs git status (~1.5s -> 0.4s)
	 config.vm.synced_folder "./", "/home/vagrant/idt_reporter/", type: "nfs", mount_options: ['rw', 'vers=3', 'tcp', 'fsc', 'actimeo=2']
    #config.vm.synced_folder "./", "/home/vagrant/idt_reporter/"
